...
func (c *authenticationClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jnx.jet.authentication.Authentication/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Authentication_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jnx.jet.authentication.Authentication/Login",
	}
...
var Authentication_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "jnx.jet.authentication.Authentication",
	...
	Metadata: "jnx_authentication_service.proto",
}
