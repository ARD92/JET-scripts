...
//
//	information.
type BGPMulticastRouteSpmsi struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SourcePrefixLen uint32 `protobuf:"varint,2,opt,name=source_prefix_len,json=sourcePrefixLen,proto3" json:"source_prefix_len,omitempty"`
	// [mandatory]:
	// [brief]: IPv4 or IPv6 multicast source address. Address family should be
	// same as the family of the BGP Multicast address.
	SourceAddress *common.IpAddress `protobuf:"bytes,3,opt,name=source_address,json=sourceAddress,proto3" json:"source_address,omitempty"`
	// [mandatory]:
	// [brief]: group prefix length
	GroupPrefixLen uint32 `protobuf:"varint,4,opt,name=group_prefix_len,json=groupPrefixLen,proto3" json:"group_prefix_len,omitempty"`
	// [mandatory]:
	// [brief]: IPv4 or IPv6 multicast group address. Address family should be
	// same as the family of the BGP Multicast address.
	GroupAddress *common.IpAddress `protobuf:"bytes,5,opt,name=group_address,json=groupAddress,proto3" json:"group_address,omitempty"`
	// [mandatory]:
	...
	RouterAddress *common.IpAddress `protobuf:"bytes,6,opt,name=router_address,json=routerAddress,proto3" json:"router_address,omitempty"`
}

func (x *BGPMulticastRouteSpmsi) Reset() {
	*x = BGPMulticastRouteSpmsi{}
	if protoimpl.UnsafeEnabled {
...
func (x *BGPMulticastRouteSpmsi) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BGPMulticastRouteSpmsi) ProtoMessage() {}

func (x *BGPMulticastRouteSpmsi) ProtoReflect() protoreflect.Message {
	mi := &file_jnx_routing_base_types_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BGPMulticastRouteSpmsi.ProtoReflect.Descriptor instead.
func (*BGPMulticastRouteSpmsi) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{26}
}

func (x *BGPMulticastRouteSpmsi) GetRd() *RouteDistinguisher {
	if x != nil {
		return x.Rd
	}
	return nil
...
func (x *BGPMulticastRouteSpmsi) GetSourcePrefixLen() uint32 {
	if x != nil {
...
func (x *BGPMulticastRouteSpmsi) GetSourceAddress() *common.IpAddress {
	if x != nil {
...
func (x *BGPMulticastRouteSpmsi) GetGroupPrefixLen() uint32 {
	if x != nil {
		return x.GroupPrefixLen
	}
	return 0
}

func (x *BGPMulticastRouteSpmsi) GetGroupAddress() *common.IpAddress {
	if x != nil {
...
func (x *BGPMulticastRouteSpmsi) GetRouterAddress() *common.IpAddress {
	if x != nil {
...
//
//	route key types.
type BGPMulticastRouteKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	// Types that are assignable to BgpmcastRtKeyType:
	//
	//	*BGPMulticastRouteKey_RtSpmsi
	BgpmcastRtKeyType isBGPMulticastRouteKey_BgpmcastRtKeyType `protobuf_oneof:"bgpmcast_rt_key_type"`
}

func (x *BGPMulticastRouteKey) Reset() {
	*x = BGPMulticastRouteKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *BGPMulticastRouteKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BGPMulticastRouteKey) ProtoMessage() {}

func (x *BGPMulticastRouteKey) ProtoReflect() protoreflect.Message {
	mi := &file_jnx_routing_base_types_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BGPMulticastRouteKey.ProtoReflect.Descriptor instead.
func (*BGPMulticastRouteKey) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{27}
}

func (m *BGPMulticastRouteKey) GetBgpmcastRtKeyType() isBGPMulticastRouteKey_BgpmcastRtKeyType {
	if m != nil {
		return m.BgpmcastRtKeyType
	}
	return nil
}

func (x *BGPMulticastRouteKey) GetRtSpmsi() *BGPMulticastRouteSpmsi {
	if x, ok := x.GetBgpmcastRtKeyType().(*BGPMulticastRouteKey_RtSpmsi); ok {
		return x.RtSpmsi
	}
	return nil
}

type isBGPMulticastRouteKey_BgpmcastRtKeyType interface {
	isBGPMulticastRouteKey_BgpmcastRtKeyType()
}

type BGPMulticastRouteKey_RtSpmsi struct {
	// [brief]: S-PMSI AD Route type
	RtSpmsi *BGPMulticastRouteSpmsi `protobuf:"bytes,1,opt,name=rt_spmsi,json=rtSpmsi,proto3,oneof"`
}

func (*BGPMulticastRouteKey_RtSpmsi) isBGPMulticastRouteKey_BgpmcastRtKeyType() {}

// [brief]: BGP Multicast Leaf A-D Address Route key fields.
// [detail]: BGP Multicast Leaf A-D route with route key and originating
//
//	router information.
type BGPMulticastRouteLeaf struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	RtKey *BGPMulticastRouteKey `protobuf:"bytes,1,opt,name=rt_key,json=rtKey,proto3" json:"rt_key,omitempty"`
	// [mandatory]:
	// [brief]: IPv4 or IPv6 Leaf router address. Address family should be same
	// as the family of the BGP Multicast address.
	LeafAddress *common.IpAddress `protobuf:"bytes,2,opt,name=leaf_address,json=leafAddress,proto3" json:"leaf_address,omitempty"`
}

func (x *BGPMulticastRouteLeaf) Reset() {
	*x = BGPMulticastRouteLeaf{}
	if protoimpl.UnsafeEnabled {
...
func (x *BGPMulticastRouteLeaf) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BGPMulticastRouteLeaf) ProtoMessage() {}

func (x *BGPMulticastRouteLeaf) ProtoReflect() protoreflect.Message {
	mi := &file_jnx_routing_base_types_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BGPMulticastRouteLeaf.ProtoReflect.Descriptor instead.
func (*BGPMulticastRouteLeaf) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{28}
}

func (x *BGPMulticastRouteLeaf) GetRtKey() *BGPMulticastRouteKey {
	if x != nil {
		return x.RtKey
	}
	return nil
...
func (x *BGPMulticastRouteLeaf) GetLeafAddress() *common.IpAddress {
	if x != nil {
...
//	IPv6 addresses.
type BGPMulticastAddress struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// [brief]: Route type
	//
	// Types that are assignable to BgpmcastRtType:
	//
	//	*BGPMulticastAddress_RtLeaf
	BgpmcastRtType isBGPMulticastAddress_BgpmcastRtType `protobuf_oneof:"bgpmcast_rt_type"`
}

func (x *BGPMulticastAddress) Reset() {
	*x = BGPMulticastAddress{}
	if protoimpl.UnsafeEnabled {
...
func (x *BGPMulticastAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BGPMulticastAddress) ProtoMessage() {}

func (x *BGPMulticastAddress) ProtoReflect() protoreflect.Message {
	mi := &file_jnx_routing_base_types_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BGPMulticastAddress.ProtoReflect.Descriptor instead.
func (*BGPMulticastAddress) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{29}
}

func (m *BGPMulticastAddress) GetBgpmcastRtType() isBGPMulticastAddress_BgpmcastRtType {
	if m != nil {
		return m.BgpmcastRtType
	}
	return nil
}

func (x *BGPMulticastAddress) GetRtLeaf() *BGPMulticastRouteLeaf {
	if x, ok := x.GetBgpmcastRtType().(*BGPMulticastAddress_RtLeaf); ok {
		return x.RtLeaf
	}
	return nil
}

type isBGPMulticastAddress_BgpmcastRtType interface {
	isBGPMulticastAddress_BgpmcastRtType()
}

type BGPMulticastAddress_RtLeaf struct {
	// [brief]: Route Leaf AD
	RtLeaf *BGPMulticastRouteLeaf `protobuf:"bytes,1,opt,name=rt_leaf,json=rtLeaf,proto3,oneof"`
}

func (*BGPMulticastAddress_RtLeaf) isBGPMulticastAddress_BgpmcastRtType() {}
...
type FlowspecAddress struct {
	...
	// OPTIONAL
	TcpFlags common.TcpFlags `protobuf:"varint,11,opt,name=tcp_flags,json=tcpFlags,proto3,enum=jnx.jet.common.TcpFlags" json:"tcp_flags,omitempty"`
	// [brief]: ICMP types to match for filtering.
	// [detail]: Standard ICMP type values defined by IANA can be used for this.
	// Ref: https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml#icmp-parameters-types
	// Note that the values are not validated, used as is mentioned in range.
...
type RoutePrefix struct {
	...
	//	*RoutePrefix_InetBgpmcast
	//	*RoutePrefix_Inet6Bgpmcast
...
func (x *RoutePrefix) GetInetBgpmcast() *BGPMulticastAddress {
	if x, ok := x.GetRoutePrefixAf().(*RoutePrefix_InetBgpmcast); ok {
		return x.InetBgpmcast
	}
	return nil
}

func (x *RoutePrefix) GetInet6Bgpmcast() *BGPMulticastAddress {
	if x, ok := x.GetRoutePrefixAf().(*RoutePrefix_Inet6Bgpmcast); ok {
		return x.Inet6Bgpmcast
	}
	return nil
}
...
type RoutePrefix_InetBgpmcast struct {
	// [brief]: BGP Multicast IPv4 prefix.
	InetBgpmcast *BGPMulticastAddress `protobuf:"bytes,11,opt,name=inet_bgpmcast,json=inetBgpmcast,proto3,oneof"`
}

type RoutePrefix_Inet6Bgpmcast struct {
	// [brief]: BGP Multicast IPv6 prefix.
	Inet6Bgpmcast *BGPMulticastAddress `protobuf:"bytes,12,opt,name=inet6_bgpmcast,json=inet6Bgpmcast,proto3,oneof"`
}
...
func (*RoutePrefix_InetBgpmcast) isRoutePrefix_RoutePrefixAf() {}

func (*RoutePrefix_Inet6Bgpmcast) isRoutePrefix_RoutePrefixAf() {}
...
func (x *NetworkAddress) Reset() {
	*x = NetworkAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_jnx_routing_base_types_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NetworkAddress) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{32}
}
...
func (x *Community) Reset() {
	*x = Community{}
	if protoimpl.UnsafeEnabled {
		mi := &file_jnx_routing_base_types_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Community) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{33}
}
...
func (x *Communities) Reset() {
	*x = Communities{}
	if protoimpl.UnsafeEnabled {
		mi := &file_jnx_routing_base_types_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Communities) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{34}
}
...
func (x *AsPath) Reset() {
	*x = AsPath{}
	if protoimpl.UnsafeEnabled {
		mi := &file_jnx_routing_base_types_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AsPath) Descriptor() ([]byte, []int) {
	return file_jnx_routing_base_types_proto_rawDescGZIP(), []int{35}
}
...
var file_jnx_routing_base_types_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x61, 0x66, 0x22, 0xec, 0x02, 0x0a, 0x16, 0x42,
	0x47, 0x50, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x63, 0x61, 0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65,
	0x53, 0x70, 0x6d, 0x73, 0x69, 0x12, 0x38, 0x0a, 0x02, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x28, 0x2e, 0x6a, 0x6e, 0x78, 0x2e, 0x6a, 0x65, 0x74, 0x2e, 0x72, 0x6f, 0x75, 0x74,
	0x69, 0x6e, 0x67, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x44, 0x69,
	...
	0x5f, 0x6c, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4c, 0x65, 0x6e, 0x12, 0x40, 0x0a, 0x0e, 0x73,
	...
	,
	...
	,
...
var file_jnx_routing_base_types_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_jnx_routing_base_types_proto_goTypes = []interface{}{
	...
	(*BGPMulticastRouteSpmsi)(nil),    // 31: jnx.jet.routing.base.BGPMulticastRouteSpmsi
	(*BGPMulticastRouteKey)(nil),      // 32: jnx.jet.routing.base.BGPMulticastRouteKey
	(*BGPMulticastRouteLeaf)(nil),     // 33: jnx.jet.routing.base.BGPMulticastRouteLeaf
	(*BGPMulticastAddress)(nil),       // 34: jnx.jet.routing.base.BGPMulticastAddress
	(*FlowspecAddress)(nil),           // 35: jnx.jet.routing.base.FlowspecAddress
	(*RoutePrefix)(nil),               // 36: jnx.jet.routing.base.RoutePrefix
	(*NetworkAddress)(nil),            // 37: jnx.jet.routing.base.NetworkAddress
	(*Community)(nil),                 // 38: jnx.jet.routing.base.Community
	(*Communities)(nil),               // 39: jnx.jet.routing.base.Communities
	(*AsPath)(nil),                    // 40: jnx.jet.routing.base.AsPath
	(*common.IpAddress)(nil),          // 41: jnx.jet.common.IpAddress
	(*common.NumericRangeList)(nil),   // 42: jnx.jet.common.NumericRangeList
	(common.TcpFlags)(0),              // 43: jnx.jet.common.TcpFlags
	(*common.IpFragementFlags)(nil),   // 44: jnx.jet.common.IpFragementFlags
}
var file_jnx_routing_base_types_proto_depIdxs = []int32{
	...
	41, // 2: jnx.jet.routing.base.RdType1.ip_address:type_name -> jnx.jet.common.IpAddress
	...
	41, // 7: jnx.jet.routing.base.L3vpnAddress.vpn_addr:type_name -> jnx.jet.common.IpAddress
	...
	41, // 17: jnx.jet.routing.base.SRTEAddress.destination:type_name -> jnx.jet.common.IpAddress
	...
	11, // 27: jnx.jet.routing.base.BGPMulticastRouteSpmsi.rd:type_name -> jnx.jet.routing.base.RouteDistinguisher
	41, // 28: jnx.jet.routing.base.BGPMulticastRouteSpmsi.source_address:type_name -> jnx.jet.common.IpAddress
	41, // 29: jnx.jet.routing.base.BGPMulticastRouteSpmsi.group_address:type_name -> jnx.jet.common.IpAddress
	41, // 30: jnx.jet.routing.base.BGPMulticastRouteSpmsi.router_address:type_name -> jnx.jet.common.IpAddress
	31, // 31: jnx.jet.routing.base.BGPMulticastRouteKey.rt_spmsi:type_name -> jnx.jet.routing.base.BGPMulticastRouteSpmsi
	32, // 32: jnx.jet.routing.base.BGPMulticastRouteLeaf.rt_key:type_name -> jnx.jet.routing.base.BGPMulticastRouteKey
	41, // 33: jnx.jet.routing.base.BGPMulticastRouteLeaf.leaf_address:type_name -> jnx.jet.common.IpAddress
	33, // 34: jnx.jet.routing.base.BGPMulticastAddress.rt_leaf:type_name -> jnx.jet.routing.base.BGPMulticastRouteLeaf
	41, // 35: jnx.jet.routing.base.FlowspecAddress.destination:type_name -> jnx.jet.common.IpAddress
	41, // 36: jnx.jet.routing.base.FlowspecAddress.source:type_name -> jnx.jet.common.IpAddress
	42, // 37: jnx.jet.routing.base.FlowspecAddress.ip_protocols:type_name -> jnx.jet.common.NumericRangeList
	42, // 38: jnx.jet.routing.base.FlowspecAddress.ports:type_name -> jnx.jet.common.NumericRangeList
	42, // 39: jnx.jet.routing.base.FlowspecAddress.dest_ports:type_name -> jnx.jet.common.NumericRangeList
	42, // 40: jnx.jet.routing.base.FlowspecAddress.src_ports:type_name -> jnx.jet.common.NumericRangeList
	42, // 41: jnx.jet.routing.base.FlowspecAddress.icmp_types:type_name -> jnx.jet.common.NumericRangeList
	42, // 42: jnx.jet.routing.base.FlowspecAddress.icmp_codes:type_name -> jnx.jet.common.NumericRangeList
	43, // 43: jnx.jet.routing.base.FlowspecAddress.tcp_flags:type_name -> jnx.jet.common.TcpFlags
	42, // 44: jnx.jet.routing.base.FlowspecAddress.pkt_lengths:type_name -> jnx.jet.common.NumericRangeList
	42, // 45: jnx.jet.routing.base.FlowspecAddress.dscps:type_name -> jnx.jet.common.NumericRangeList
	44, // 46: jnx.jet.routing.base.FlowspecAddress.fragment:type_name -> jnx.jet.common.IpFragementFlags
	41, // 47: jnx.jet.routing.base.RoutePrefix.inet:type_name -> jnx.jet.common.IpAddress
	41, // 48: jnx.jet.routing.base.RoutePrefix.inet6:type_name -> jnx.jet.common.IpAddress
	12, // 49: jnx.jet.routing.base.RoutePrefix.inetvpn:type_name -> jnx.jet.routing.base.L3vpnAddress
	12, // 50: jnx.jet.routing.base.RoutePrefix.inet6vpn:type_name -> jnx.jet.routing.base.L3vpnAddress
	41, // 51: jnx.jet.routing.base.RoutePrefix.labeled_inet:type_name -> jnx.jet.common.IpAddress
	41, // 52: jnx.jet.routing.base.RoutePrefix.labeled_inet6:type_name -> jnx.jet.common.IpAddress
	27, // 53: jnx.jet.routing.base.RoutePrefix.inet_srte_policy:type_name -> jnx.jet.routing.base.SRTEAddress
	27, // 54: jnx.jet.routing.base.RoutePrefix.inet6_srte_policy:type_name -> jnx.jet.routing.base.SRTEAddress
	35, // 55: jnx.jet.routing.base.RoutePrefix.inet_flowspec:type_name -> jnx.jet.routing.base.FlowspecAddress
	35, // 56: jnx.jet.routing.base.RoutePrefix.inet6_flowspec:type_name -> jnx.jet.routing.base.FlowspecAddress
	34, // 57: jnx.jet.routing.base.RoutePrefix.inet_bgpmcast:type_name -> jnx.jet.routing.base.BGPMulticastAddress
	34, // 58: jnx.jet.routing.base.RoutePrefix.inet6_bgpmcast:type_name -> jnx.jet.routing.base.BGPMulticastAddress
	41, // 59: jnx.jet.routing.base.NetworkAddress.inet:type_name -> jnx.jet.common.IpAddress
	41, // 60: jnx.jet.routing.base.NetworkAddress.inet6:type_name -> jnx.jet.common.IpAddress
	15, // 61: jnx.jet.routing.base.NetworkAddress.mpls:type_name -> jnx.jet.routing.base.MplsAddress
	38, // 62: jnx.jet.routing.base.Communities.communities:type_name -> jnx.jet.routing.base.Community
...
func file_jnx_routing_base_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_jnx_routing_base_types_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BGPMulticastRouteSpmsi); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_jnx_routing_base_types_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BGPMulticastRouteKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_jnx_routing_base_types_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BGPMulticastRouteLeaf); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_jnx_routing_base_types_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BGPMulticastAddress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_jnx_routing_base_types_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_jnx_routing_base_types_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_jnx_routing_base_types_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_jnx_routing_base_types_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AsPath); i {
			case 0:
				return &v.state
			case 1:
	...
	file_jnx_routing_base_types_proto_msgTypes[27].OneofWrappers = []interface{}{
		(*BGPMulticastRouteKey_RtSpmsi)(nil),
	}
	file_jnx_routing_base_types_proto_msgTypes[29].OneofWrappers = []interface{}{
		(*BGPMulticastAddress_RtLeaf)(nil),
	}
	file_jnx_routing_base_types_proto_msgTypes[31].OneofWrappers = []interface{}{
		...
		(*RoutePrefix_InetBgpmcast)(nil),
		(*RoutePrefix_Inet6Bgpmcast)(nil),
	}
	file_jnx_routing_base_types_proto_msgTypes[32].OneofWrappers = []interface{}{
